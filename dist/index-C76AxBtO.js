import { l as WalletNotConnectedError, W as WalletReadyState, d as WalletDisconnectedError, P as PublicKey, e as WalletPublicKeyError, s as scopePollingDetectionStrategy, i as isIosAndRedirectable, f as WalletNotReadyError, q as WalletLoadError, t as WalletConfigError, h as WalletConnectionError, k as WalletDisconnectionError, m as WalletError, n as WalletSendTransactionError, o as WalletSignTransactionError, p as WalletSignMessageError } from "./index-9Rmuwpsp.js";
import { B as BaseMessageSignerWalletAdapter, i as isVersionedTransaction } from "./signer-B3BsLmyh.js";
  ...
  constructor() {
    ...
    _SolflareMetaMaskWallet_connect.set(this, async () => {
      if (!__classPrivateFieldGet(this, _SolflareMetaMaskWallet_solflareMetaMask, "f")) {
        ...
        try {
          SolflareMetaMaskClass = (await import("./index-C7RPUT4F.js")).default;
        } catch (error) {
...
class SolflareWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./index-BFr2ygCx.js")).default;
      } catch (error) {
...
export {
  ...
  SolanaSignTransaction as a,
  SolanaSignMessage as b,
  index as i
};
